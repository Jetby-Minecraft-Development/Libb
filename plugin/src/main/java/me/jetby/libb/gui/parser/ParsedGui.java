...
import me.jetby.libb.gui.PaginatedGui;
 ...
 */
@Getter
public class ParsedGui extends PaginatedGui {
    ...
    public ParsedGui(@NotNull Player viewer, @NotNull Gui guiDefinition, JavaPlugin plugin) {
        ...
        super(guiDefinition.title(), guiDefinition.size(), Libb.CONFIG_COLORIZER.getType());
    ...
    public ParsedGui(@NotNull Player viewer, @NotNull FileConfiguration config, JavaPlugin plugin) {
        super(config.getString("title", ""), config.getInt("size", 54), Libb.CONFIG_COLORIZER.getType());
        this.viewer = viewer;
        this.plugin = plugin;
